...
workflow.add_conditional_edges(
    "steps_node",
    route,
    {"web_search_node": "web_search_node", "wikipedia_search_node": "wikipedia_search_node", END: END}
)
...
call_me_back = ["wikipedia_search_node","web_search_node"]

workflow.add_conditional_edges(
    "download_node",
    lambda state: "summarizer_node" if all(step["status"] == "complete" for step in state.get("steps", [])) else call_me_back,
    {
