...
ADD requirements.txt /deps/__outer_fact_checker/fact_checker/requirements.txt
RUN PYTHONDONTWRITEBYTECODE=1 pip install --no-cache-dir -c /api/constraints.txt -r /deps/__outer_fact_checker/fact_checker/requirements.txt
# -- End of local requirements install --

# -- Adding non-package dependency fact_checker --
...
ENV LANGSERVE_GRAPHS='{"agent": "/deps/__outer_fact_checker/fact_checker/fact_checker_agent/agent.py:graph"}'
